...
Click the command console <Image src="commit/command-console.png" alt="command console icon" className="inline" />, then select `Config library`.  Once that is open, select `Git` from the tree at left and type in your name and email in the **Committer** box.
...
Now that you know your way around commits, we can take a look at [branches](/branches).
