...
- You can [open an existing working copy](/intro/open-working-copy) if you've already got one setup
- You can [clone an existing repository](/intro/clone)
- You can [init a brand new repository](/intro/init) to start a new project
