...
<Video
	poster="/branches/reflog/reflog-delete.png"
	source="/branches/reflog/reflog-delete.mp4"
/>
...
<Video
	poster="/branches/reflog/reflog-branch.png"
	source="/branches/reflog/reflog-branch.mp4"
/>
...
<Video
	poster="/branches/reflog/reflog-head.png"
	source="/branches/reflog/reflog-head.mp4"
/>
...
Using the reflog to delete and recover your work should definitely not be plan A.  There's a much better mechanism called "Save for later", which we'll [look at next](/branches/save-for-later.md).
