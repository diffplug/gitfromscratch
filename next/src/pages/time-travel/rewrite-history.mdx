...
<Video
  poster="/time-travel/rewrite-history/squash.png"
  source="/time-travel/rewrite-history/squash.mp4"
/>
...
<Video
  poster="/time-travel/rewrite-history/rewrite-setup.png"
  source="/time-travel/rewrite-history/rewrite-setup.mp4"
/>
...
<Video
  poster="/time-travel/rewrite-history/rewrite-summary-merge.png"
  source="/time-travel/rewrite-history/rewrite-summary-merge.mp4"
/>
...
<Video
  poster="/time-travel/rewrite-history/rewrite-reorder-and-omit.png"
  source="/time-travel/rewrite-history/rewrite-reorder-and-omit.mp4"
/>

It is also possible to split a large commit into multiple smaller ones, or vice-versa.

<Video
  poster="/time-travel/rewrite-history/rewrite-split-and-combine.png"
  source="/time-travel/rewrite-history/rewrite-split-and-combine.mp4"
/>
