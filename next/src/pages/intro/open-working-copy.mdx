...
To open an existing working copy, drag the folder from your file explorer onto DiffPlug's <Image src="diff-list-icon.png" alt="DiffPlug icon" className="inline m-0" /> icon. Then right-click it and select `Git -> History`.
