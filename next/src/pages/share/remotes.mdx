...
<Video
  poster="/share/remotes/remotes-browse.png"
  source="/share/remotes/remotes-browse.mp4"
/>
...
<Video
  poster="/share/remotes/remotes-local.png"
  source="/share/remotes/remotes-local.mp4"
/>

To add a normal `https` or `ssh/git` remote, just click the plus.

<Image
  src="/share/remotes/remotes-add.png"
  alt="Add a remote"
  width={620}
  height={460}
/>
